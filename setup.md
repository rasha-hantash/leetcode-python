...
5. **Verify.** Open `prep-plan-daily.md`. The curriculum-reference layout should render normally. The live queue lives in `prep-data/today.md` — generated by step 3 (Python toolchain) below.
