...
5. **Verify.** Open `curriculum.md` (flat by-pattern reference). The live queue lives in `prep-data/today.md` — generated by step 3 (Python toolchain) below.
...
3. Afternoon SD (14–15:30): tick the chapter box in `prep-data/today.md`'s **Today's SD reading** section.
4. DSA New (15:30–19:30): solve `prep-data/today.md`'s **New** section, tick the boxes there.
