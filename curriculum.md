...
Source of truth — flat by-pattern list. The engine reads this for problem metadata.
For phase budgets see [`phases.json`](./phases.json). For progress see [`prep-data/coverage.md`](./prep-data/coverage.md).

_Live daily queue: [`prep-data/today.md`](./prep-data/today.md), generated by `uv run prep recompute`._
...
_Total: 182 problems across 26 patterns._
